...
from jsk_recognition_msgs.msg import RectArray,PeoplePoseArray
...
class check_node():
    def __init__(self):
        ...
        self.pose=[new_Point2D(0,0),False]
        ...
        self.sub_pose=rospy.Subscriber('edgetpu_human_pose_detector/output/poses',PeoplePoseArray,self.callback_pose)
    ...
    def calc_distance(self):
        if self.point_blue[1] and self.point_green[1] and self.pose[1]:
